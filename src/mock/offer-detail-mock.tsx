export const offerDetailMock = [
  {
    'id': '229f3905-b3bc-4026-bdcc-7fafd5c27b29',
    'title': 'The Joshua Tree House',
    'description': 'This is a place for dreamers to reset, reflect, and create. Designed with a slow pace in mind, our ' +
      'hope is that you enjoy every part of your stay; from making local coffee by drip in the morning, choosing the ' +
      'perfect record to put on as the sun sets.',
    'type': 'apartment',
    'price': 367,
    'images': [
  ...
  },
  {
    ...
    'title': 'The Joshua Tree House',
    'description': 'Peaceful studio in the most wanted area in town. Quiet house Near of everything. Completely ' +
      'renovated. Lovely neighbourhood, lot of trendy shops, restaurants and bars in a walking distance.',
    'type': 'house',
    'price': 257,
    'images': [
      'https://15.design.htmlacademy.pro/static/hotel/19.jpg',
